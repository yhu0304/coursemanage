...
<html>
  ...
  <body onload="load()">
  <form action="/CourseManage/Opinion/STOpinion" method="post" onsubmit="return check();">
    <table bgcolor="#cbe2e4" border="1px" cellspacing="0px"style="border-collapse:collapse">
    	...
    	<tr><td class="class3" colspan="1"><input class="class4" type="submit" name="submit" value="提交修改" align="middle" onclick="return check1()"/></td></tr>
    </table>
    </form>
    <%
